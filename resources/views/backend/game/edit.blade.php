...
@section('content')
    <div class="nk-block-head">
        <div class="nk-block-head-content">
            <h4 class="title nk-block-title float-left">Edit Game</h4>
        </div>
    ...
    <div class="card card-bordered">
        <div class="card-inner">
            <form action="{{ route('game.update', $game->id) }}" id="form" method="post">
                @csrf
                @method('patch')
                <div class="row gy-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" data-msg="This field is required" class="form-control required"
                                    name="name" placeholder="Enter Name" value="{{ old('name', $game->name) }}" required>
                                @if ($errors->has('name'))
                    ...
                    <div class="col-md-12">
                        <button id="submitBtn" class="btn btn-primary">Update Details</button>
                    </div>
                </div>
            </form>
        </div>
