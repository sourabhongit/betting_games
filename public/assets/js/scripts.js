    ...
    NioApp.DataTable.init = function () {
        NioApp.DataTable('.datatable-init', {
            ...
            "initComplete": function (settings, json) {
                $(".datatable-init").wrap("<div style='overflow:auto; width:100%;position:relative;min-height:475px;'></div>");
            },
        ...
        NioApp.DataTable('.datatable-init-export', {
            ...
            pageLength: 50,
            "initComplete": function (settings, json) {
                $("#datatable-init-export").wrap("<div style='overflow:auto; width:100%;position:relative;'></div>");
            },
